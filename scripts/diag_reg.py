...
def main():
    ...
    ap.add_argument("--loss_pow", type=float, default=1.0)
    ...
    for r in range(a.n_rounds):
        ...
        s, phi = metagrad_scores(params, tok[idx], val, cfg, T=a.T, lr=a.lr,
                                 val_bs=a.val_bs, L_inner=a.L_inner, wd=a.wd, loss_clip=a.loss_clip, loss_pow=a.loss_pow)
    ...
    out = dict(wd=a.wd, loss_clip=a.loss_clip, loss_pow=a.loss_pow, T=a.T, lr=a.lr, k=a.k, n_rounds=a.n_rounds,
